 ...
 */
	function ls_html_calendrier($jour = 0, $mois = 0, $annee = 0){
		if($annee<2012){
			$jour=date('j',time());
			$mois=date('n',time());
			$annee=date('Y',time());	
		...
		echo '<section id="calendrier">',
			'<p>',
				'<a href="#" class="flechegauche"><img src="../images/fleche_gauche.png" alt="picto fleche gauche"></a>',$mois_nom[$mois-1],' ',$annee,
